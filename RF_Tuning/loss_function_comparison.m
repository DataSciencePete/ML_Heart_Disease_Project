...
%% MCR as loss function - Run Bayesian Optimisation using MCR as error value to evaluate objective 20 times and generate 20 calculations for numTrees, minLS and numPTS
...
for i = 1:20
    ...
    % Optimisation
    results_paralllel_MCR = bayesopt(@(params)lossFcn_RF_MCR(params,In_high_imp_variables,train_labels,par,cvp),hyperparametersRF, 'MaxObjectiveEvaluations', 30, 'UseParallel',true, 'ExplorationRatio', 0.5, 'Verbose',1);
...
%% CE as loss function - Run Bayesian Optimisation using ce as error value to evaluate objective 20 times and generate 20 calculations for numTrees, minLS and numPTS
...
for i = 1:20
    ...
    % Output hyperparamter settings for optimal model generated by Bayesian
    % Optimisation
    results_paralllel_CE = bayesopt(@(params)lossFcn_RF_CE(params,In_high_imp_variables,train_labels,par,cvp),hyperparametersRF, 'MaxObjectiveEvaluations', 30, 'UseParallel',true, 'ExplorationRatio', 0.5, 'Verbose',1);
