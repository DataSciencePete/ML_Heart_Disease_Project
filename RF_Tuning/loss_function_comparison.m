...
for i = 1:20
    ...
    results_parallel_MCR = bayesopt(@(params)lossFcn_RF_MCR(params,In_high_imp_variables,train_labels,par,cvp),hyperparametersRF, 'MaxObjectiveEvaluations', 30, 'UseParallel',useParallel, 'ExplorationRatio', 0.5, 'Verbose',1);
    minLS_MCR = results_parallel_MCR.XAtMinEstimatedObjective.minLS;
    numPTS_MCR = results_parallel_MCR.XAtMinEstimatedObjective.numPTS;
    numTrees_MCR = results_parallel_MCR.XAtMinEstimatedObjective.numTrees;
...
for i = 1:20
    ...
    results_paralllel_CE = bayesopt(@(params)lossFcn_RF_CE(params,In_high_imp_variables,train_labels,par,cvp),hyperparametersRF, 'MaxObjectiveEvaluations', 30, 'UseParallel', useParallel, 'ExplorationRatio', 0.5, 'Verbose',1);
